...
export async function formatters(
  ...
  if (options.markdown) {
    ...
    configs.push({
      ...
      name: 'keksiqc/formatter/markdown',
      rules: {
        [`format/${formater}`]: [
          'error',
          formater === 'prettier'
  ...
  if (options.astro) {
    ...
    configs.push({
      ...
      name: 'keksiqc/formatter/astro/disables',
      rules: {
  ...
  if (options.graphql) {
    configs.push({
      ...
      name: 'keksiqc/formatter/graphql',
      rules: {
        'format/prettier': [
          'error',
          mergePrettierOptions(prettierOptions, {
